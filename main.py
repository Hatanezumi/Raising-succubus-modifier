...
class MemoryProcess():
    def __init__(self, name:str) -> None:
        ...
        if self.pid == -1:
            raise ProcessNotFoundError('未找到游戏进程')
...
if __name__ == '__main__':
    try:
        ...
        with MemoryProcess('Raising succubus.exe') as game:
            ...
            os.system(f'title サキュバスの育成方法 5项修改器 v{version}')
            while True:
                os.system('cls')
                print('=' * 50 + f'\nサキュバスの育成方法 5项修改器 v{version}\n作者:田鼠Hatanezumi\n' + '=' * 50)
                print('-' * 50 + '\n当前数值:')
                ...
                if choose == '1':
                    ...
                    continue
                os.system('pause')
    except ProcessNotFoundError as err:
        print(err)
    except:
        print('发生了意料之外的错误,详细信息:\n{}'.format(traceback.format_exc()))
    finally:
        os.system('pause') if not exit else None